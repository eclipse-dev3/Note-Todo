            ...
            <ul className="absolute bottom-1 left-0 w-full border-t border-white/30">
                ...
                <li className="p-3  flex items-center justify-evenly gap-2">
                    ...
                    <a href="https://gaurav-kumar-03.vercel.app" target="_blank" className="relative group">
                        ...
                        <span
                            className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 text-xs font-semibold text-white bg-[#5e40b1] rounded-md shadow-[0px_0px_8px_2px_rgba(93,64,177,0.8)] opacity-0 group-hover:opacity-100 transition-all duration-300"
                        >
                            Portfolio
                        </span>
                    </a>
